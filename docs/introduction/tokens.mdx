...
**Paradigm models don't actually process text as a sequence of characters or words, but as a sequence of tokens.**
...
On average, a word equals 3/4 tokens, or 4 characters in English. This will also vary
with the style of the text: "simple" writing will use fewer tokens (on average one per word),
whereas complex technical writing will use more.
